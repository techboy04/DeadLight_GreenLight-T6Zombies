...
CoD.PrivateGameLobby.DeadlightOptions = {}
CoD.PrivateGameLobby.DeadlightOptions[1] = {}
CoD.PrivateGameLobby.DeadlightOptions[1].id = "enable_deadlightgreenlight"
CoD.PrivateGameLobby.DeadlightOptions[1].name = "ENABLE GAMEMODE"
CoD.PrivateGameLobby.DeadlightOptions[1].hintText = "Enable the Deadlight Greenlight mode."
CoD.PrivateGameLobby.DeadlightOptions[1].labels = {}
CoD.PrivateGameLobby.DeadlightOptions[1].labels[1] = "ENABLED"
CoD.PrivateGameLobby.DeadlightOptions[1].labels[2] = "DISABLED"
CoD.PrivateGameLobby.DeadlightOptions[1].values = {}
CoD.PrivateGameLobby.DeadlightOptions[1].values[1] = 1
CoD.PrivateGameLobby.DeadlightOptions[1].values[2] = 0
CoD.PrivateGameLobby.DeadlightOptions[1].maps = {}
CoD.PrivateGameLobby.DeadlightOptions[1].maps[1] = "zm_transit"
CoD.PrivateGameLobby.DeadlightOptions[1].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.DeadlightOptions[1].maps[3] = "zm_buried"
CoD.PrivateGameLobby.DeadlightOptions[1].maps[4] = "zm_prison"
CoD.PrivateGameLobby.DeadlightOptions[1].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.DeadlightOptions[1].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.DeadlightOptions[1].gameTypes = {}
CoD.PrivateGameLobby.DeadlightOptions[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.DeadlightOptions[1].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.DeadlightOptions[2] = {}
CoD.PrivateGameLobby.DeadlightOptions[2].id = "deadlight_rules"
CoD.PrivateGameLobby.DeadlightOptions[2].name = "MOVE PUNISHMENT"
CoD.PrivateGameLobby.DeadlightOptions[2].hintText = "If a player moves during Red light, what should they get."
CoD.PrivateGameLobby.DeadlightOptions[2].labels = {}
CoD.PrivateGameLobby.DeadlightOptions[2].labels[1] = "LOSE POINTS + PUNISHMENT"
CoD.PrivateGameLobby.DeadlightOptions[2].labels[2] = "ONLY LOSING POINTS"
CoD.PrivateGameLobby.DeadlightOptions[2].labels[3] = "ONLY GETTING PUNISHED"
CoD.PrivateGameLobby.DeadlightOptions[2].labels[4] = "INSTANT DOWN"
CoD.PrivateGameLobby.DeadlightOptions[2].values = {}
CoD.PrivateGameLobby.DeadlightOptions[2].values[1] = 0
CoD.PrivateGameLobby.DeadlightOptions[2].values[2] = 1
CoD.PrivateGameLobby.DeadlightOptions[2].values[3] = 3
CoD.PrivateGameLobby.DeadlightOptions[2].values[4] = 2
CoD.PrivateGameLobby.DeadlightOptions[2].maps = {}
CoD.PrivateGameLobby.DeadlightOptions[2].maps[1] = "zm_transit"
CoD.PrivateGameLobby.DeadlightOptions[2].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.DeadlightOptions[2].maps[3] = "zm_buried"
CoD.PrivateGameLobby.DeadlightOptions[2].maps[4] = "zm_prison"
CoD.PrivateGameLobby.DeadlightOptions[2].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.DeadlightOptions[2].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.DeadlightOptions[2].gameTypes = {}
CoD.PrivateGameLobby.DeadlightOptions[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.DeadlightOptions[2].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.DeadlightOptions[3] = {}
CoD.PrivateGameLobby.DeadlightOptions[3].id = "deadlight_copyright"
CoD.PrivateGameLobby.DeadlightOptions[3].name = "COPYRIGHTED CONTENT"
CoD.PrivateGameLobby.DeadlightOptions[3].hintText = "Toggle if you want copyrighted content. Recommended to be disabled for Creators."
CoD.PrivateGameLobby.DeadlightOptions[3].labels = {}
CoD.PrivateGameLobby.DeadlightOptions[3].labels[1] = "ENABLED"
CoD.PrivateGameLobby.DeadlightOptions[3].labels[2] = "DISABLED"
CoD.PrivateGameLobby.DeadlightOptions[3].values = {}
CoD.PrivateGameLobby.DeadlightOptions[3].values[1] = 1
CoD.PrivateGameLobby.DeadlightOptions[3].values[2] = 0
CoD.PrivateGameLobby.DeadlightOptions[3].maps = {}
CoD.PrivateGameLobby.DeadlightOptions[3].maps[1] = "zm_transit"
CoD.PrivateGameLobby.DeadlightOptions[3].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.DeadlightOptions[3].maps[3] = "zm_buried"
CoD.PrivateGameLobby.DeadlightOptions[3].maps[4] = "zm_prison"
CoD.PrivateGameLobby.DeadlightOptions[3].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.DeadlightOptions[3].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.DeadlightOptions[3].gameTypes = {}
CoD.PrivateGameLobby.DeadlightOptions[3].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.DeadlightOptions[3].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.DeadlightOptions[4] = {}
CoD.PrivateGameLobby.DeadlightOptions[4].id = "deadlight_voice"
CoD.PrivateGameLobby.DeadlightOptions[4].name = "LIGHT VOICE"
CoD.PrivateGameLobby.DeadlightOptions[4].hintText = "The voice that says Red light and Green light."
CoD.PrivateGameLobby.DeadlightOptions[4].labels = {}
CoD.PrivateGameLobby.DeadlightOptions[4].labels[1] = "NO VOICE - IN-GAME SOUNDS"
CoD.PrivateGameLobby.DeadlightOptions[4].labels[2] = "STATUE ENTITY"
CoD.PrivateGameLobby.DeadlightOptions[4].labels[3] = "YOUNG-HEE"
CoD.PrivateGameLobby.DeadlightOptions[4].values = {}
CoD.PrivateGameLobby.DeadlightOptions[4].values[1] = 0
CoD.PrivateGameLobby.DeadlightOptions[4].values[2] = 1
CoD.PrivateGameLobby.DeadlightOptions[4].values[3] = 2
CoD.PrivateGameLobby.DeadlightOptions[4].maps = {}
CoD.PrivateGameLobby.DeadlightOptions[4].maps[1] = "zm_transit"
CoD.PrivateGameLobby.DeadlightOptions[4].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.DeadlightOptions[4].maps[3] = "zm_buried"
CoD.PrivateGameLobby.DeadlightOptions[4].maps[4] = "zm_prison"
CoD.PrivateGameLobby.DeadlightOptions[4].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.DeadlightOptions[4].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.DeadlightOptions[4].gameTypes = {}
CoD.PrivateGameLobby.DeadlightOptions[4].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.DeadlightOptions[4].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.DeadlightOptions[5] = {}
CoD.PrivateGameLobby.DeadlightOptions[5].id = "enable_deadlight_vox"
CoD.PrivateGameLobby.DeadlightOptions[5].name = "MOD SUBTITLES"
CoD.PrivateGameLobby.DeadlightOptions[5].hintText = "Choose to toggle mod specific subtitles and/or audio."
CoD.PrivateGameLobby.DeadlightOptions[5].labels = {}
CoD.PrivateGameLobby.DeadlightOptions[5].labels[1] = "BOTH AUDIO AND SUBTITLES"
CoD.PrivateGameLobby.DeadlightOptions[5].labels[2] = "ONLY AUDIO"
CoD.PrivateGameLobby.DeadlightOptions[5].labels[3] = "ONLY SUBTITLES"
CoD.PrivateGameLobby.DeadlightOptions[5].labels[4] = "DISABLED"
CoD.PrivateGameLobby.DeadlightOptions[5].values = {}
CoD.PrivateGameLobby.DeadlightOptions[5].values[1] = 1
CoD.PrivateGameLobby.DeadlightOptions[5].values[2] = 2
CoD.PrivateGameLobby.DeadlightOptions[5].values[3] = 3
CoD.PrivateGameLobby.DeadlightOptions[5].values[4] = 0
CoD.PrivateGameLobby.DeadlightOptions[5].maps = {}
CoD.PrivateGameLobby.DeadlightOptions[5].maps[1] = "zm_transit"
CoD.PrivateGameLobby.DeadlightOptions[5].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.DeadlightOptions[5].maps[3] = "zm_buried"
CoD.PrivateGameLobby.DeadlightOptions[5].maps[4] = "zm_prison"
CoD.PrivateGameLobby.DeadlightOptions[5].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.DeadlightOptions[5].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.DeadlightOptions[5].gameTypes = {}
CoD.PrivateGameLobby.DeadlightOptions[5].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.DeadlightOptions[5].gameTypes[2] = "zstandard"
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.DeadlightOptions, "dvar")
