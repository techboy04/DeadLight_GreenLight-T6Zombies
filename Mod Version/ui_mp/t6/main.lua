...
CoD.InitArchiveDvars = function()
	if UIExpression.DvarString(nil, "enable_deadlightgreenlight") == "" then
		Engine.Exec(nil, "seta enable_deadlightgreenlight 1")
	end
	if UIExpression.DvarString(nil, "deadlight_rules") == "" then
		Engine.Exec(nil, "seta deadlight_rules 0")
	end
	if UIExpression.DvarString(nil, "deadlight_copyright") == "" then
		Engine.Exec(nil, "seta deadlight_copyright 1")
	end
	if UIExpression.DvarString(nil, "deadlight_voice") == "" then
		Engine.Exec(nil, "seta deadlight_voice 2")
	end
	if UIExpression.DvarString(nil, "enable_deadlight_vox") == "" then
		Engine.Exec(nil, "seta enable_deadlight_vox 1")
	end
end
