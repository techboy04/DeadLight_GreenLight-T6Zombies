...
main()
{
	...
	create_dvar("deadlight_copyright", 1);
	create_dvar("deadlight_voice", 2);
...
#/
	...
	{
		if(getDvarInt("deadlight_copyright") == 1)
		{
...
{
	if(audio != "" && (getDvarInt("enable_deadlight_vox") == 1 || getDvarInt("enable_deadlight_vox") == 2))
	{
		self playlocalsound(audio);
	}

	if(getDvarInt("enable_deadlight_vox") == 1 || getDvarInt("enable_deadlight_vox") == 3)
	{	
